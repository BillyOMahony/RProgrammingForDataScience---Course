...
#   Player Playing Style (2 vs 3 points) excluding Free Throws, where each free throw is worth 1 point
#   Two matrices will be needed before analysis can begin as data supplied in vectors
...
# ---------------------- CHALLENGE TASKS -------------------------- #
# First run the BasketballData script
# Free Throw Attempts Per Game
...
# Player Playing Style (2 vs 3 points) excluding Free Throws, where each free throw is worth 1 point
# First, total points - FreeThrows
PointsFromPlay <- Points - FreeThrows
myplot(PointsFromPlay/FieldGoals)
